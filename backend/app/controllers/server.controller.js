...
exports.create = (req, res) => {
  ...
  if (
    ...
    const server = new Server({
      ...
      PercentFree: req.body.PercentFree.toString(),
      TotalMemory: req.body.TotalMemory.toString(),
      FreeMemory: req.body.FreeMemory.toString(),
      UsedMemory: req.body.UsedMemory.toString(),
